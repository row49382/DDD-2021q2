...
public class ArePrerequisitesMet extends CourseRegistrationValidator {
    public ArePrerequisitesMet(CourseRegistration courseRegistration) {
        super(courseRegistration);
    }

    @Override
    public void execute() throws ValidationFailureException {
        // implementation omitted for assignment
    }
}
